...
int main(int argc, char *arv[])
{
	...
	theShaderProgram = BuildShaderProgram("E:/keplerprogram/code/vs1.glsl", "E:/keplerprogram/code/fs1.glsl");
	...
	while (bGameLoopRunning)
	{
		...
		int uniform_location = glGetUniformLocation(theShaderProgram, "uniform_color");
		assert(uniform_location != -1);
		vec4 u_Color(1.0f/v, 1.0f, 0.0f, 1.0f);
